...
const ThirdSection = () => {
    return (
        <section className='w-full py-[2.5rem] rounded-[1rem] bg-[#4dac96] my-10 flex items-center justify-center text-white'>
            <img src='/book.png' className='mx-[1rem] w-[40%]' />
            <div className='p-[2rem] w-[50rem]'>
                <h2 className='text-[2.5rem] leading-[50px] my-5 font-bold font-poppins'>
